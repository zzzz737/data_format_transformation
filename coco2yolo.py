...
parser.add_argument('-j', help='JSON file', dest='json', default='./annotations/instances_val2017.json')
parser.add_argument('-o', help='path to output folder', dest='out', default='./yolo/labels/train2017')
...
def yolo_data_test_vis():
    import cv2
    parser = argparse.ArgumentParser(description='Test yolo data.')
    parser.add_argument('-i', help='Image', dest='img', default='./yolo_coco/images/val2017/000000000139.jpg')
    parser.add_argument('-t', help='Yolo text file', dest='txt', default='./yolo/labels/train2017/000000000139.txt')
